...
/*
 * Replace: HttpClient client = new DefaultHttpClient(); original 
 * Using: HttpClient client = GemtekSSLSocketFactory.createSSLHttpClient();
 */
public class CustomSSLSocketFactory extends SSLSocketFactory {
	...
	public static HttpClient createSSLHttpClient() {
		try {
			...
			SSLSocketFactory mSSLSocketFactory = new CustomSSLSocketFactory(trustStore);
